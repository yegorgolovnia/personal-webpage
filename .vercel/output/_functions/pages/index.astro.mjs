...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Hero;
  return renderTemplate`${maybeRenderHead()}<section class="hero" id="hero-section" data-astro-cid-bbe6dxrz> <canvas id="hero-canvas" data-astro-cid-bbe6dxrz></canvas> <div class="content" data-astro-cid-bbe6dxrz> <div class="sys-msg pixel-text" data-astro-cid-bbe6dxrz>System.Boot() // Welcome</div> <h1 class="fade-in" data-astro-cid-bbe6dxrz>YEGOR GOLOVNIA</h1> <div class="subtitle pixel-text fade-in-delay" data-astro-cid-bbe6dxrz>
...
Building impact-focused organizations and scalable systems in the
            Ethereum ecosystem.
</p> </div> </section>  ${renderScript($$result, "/Users/egorgolovnia/dev/yegor-landing-page/src/components/Hero.astro?astro&type=script&index=0&lang.ts")}`;
...
</p> </div> </div> </section> <!-- Re-adding Experience per user request for future merge with Case Studies --> <section id="experience" style="margin-bottom: 4rem;" data-astro-cid-j7pv25f6> <div class="header" data-astro-cid-j7pv25f6> <h2 data-astro-cid-j7pv25f6>System.History</h2> <span class="pixel-text" data-astro-cid-j7pv25f6>/experience</span> </div> <p class="bio text-muted" style="font-size: 1rem;" data-astro-cid-j7pv25f6>
> Detailed history module loaded. (Pending data merge sequence)
</p> <!-- We can keep the component in the DOM but restyle its container later when merged --> </section> <section id="interests" data-astro-cid-j7pv25f6> <div class="header" data-astro-cid-j7pv25f6> <h2 data-astro-cid-j7pv25f6>Memory.Allocation</h2> <span class="pixel-text" data-astro-cid-j7pv25f6>/current_interests</span> </div> <ul class="interests-list" data-astro-cid-j7pv25f6> <li data-astro-cid-j7pv25f6> <span class="color-accent" data-astro-cid-j7pv25f6>></span> Agentic Workflows & Auto-Dev
                    Tools
</li> <li data-astro-cid-j7pv25f6> <span class="color-accent" data-astro-cid-j7pv25f6>></span> Terminal Aesthetics & WebGL
                    Interfaces
</li> <li data-astro-cid-j7pv25f6> <span class="color-accent" data-astro-cid-j7pv25f6>></span> Decentralized Governance Systems
</li> <li data-astro-cid-j7pv25f6> <span class="color-accent" data-astro-cid-j7pv25f6>></span> Long-distance Running & Triathlon
</li> <li data-astro-cid-j7pv25f6> <span class="color-accent" data-astro-cid-j7pv25f6>></span> Electronic Music Curation
</li> </ul> </section> ${renderComponent($$result2, "Lifestyle", $$Lifestyle, { "data-astro-cid-j7pv25f6": true })} <footer id="contact" data-astro-cid-j7pv25f6> <div class="header" data-astro-cid-j7pv25f6> <h2 data-astro-cid-j7pv25f6>Network.Connect()</h2> <span class="pixel-text" data-astro-cid-j7pv25f6>/links</span> </div> <div class="links-grid" data-astro-cid-j7pv25f6> ${links.map((link) => renderTemplate`<a${addAttribute(link.url, "href")} target="_blank" rel="noopener noreferrer" class="link-item" data-astro-cid-j7pv25f6> <span class="arrow" data-astro-cid-j7pv25f6>→</span> ${link.label} </a>`)} </div> <div class="f-credits mono" data-astro-cid-j7pv25f6> <p data-astro-cid-j7pv25f6>NO COOKIES. NO TRACKERS.</p> <p data-astro-cid-j7pv25f6>&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} Yegor Golovnia</p> </div> </footer> </div>  ` })}`;
